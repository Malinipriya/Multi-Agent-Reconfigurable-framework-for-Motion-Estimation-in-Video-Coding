...
public class PixelAgent9 extends Agent
{
...
/*			try
			...
			try
			{
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 9 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 9 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 9 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
