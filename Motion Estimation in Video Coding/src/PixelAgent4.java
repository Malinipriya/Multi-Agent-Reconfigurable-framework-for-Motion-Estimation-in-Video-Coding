...
public class PixelAgent4 extends Agent
{
		long startTime;
...
/*				try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file4.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 4 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 4 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 4 time:"+time);
