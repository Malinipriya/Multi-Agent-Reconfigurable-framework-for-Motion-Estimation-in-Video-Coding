...
public class PixelAgent5 extends Agent
{
		long startTime;
...
/*		try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file5.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 5 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 5 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 5 time:"+time);
