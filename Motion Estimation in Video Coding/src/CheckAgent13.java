		...
		try
			{
				...
				raf.close();
				RandomAccessFile raf1 = new RandomAccessFile("D:/Java/classes/human_action/file13.txt", "rw");
				...
				if(n_agents!=agent_count)
				{
					...
					raf1.writeBytes("\n"+s);
					raf1.writeBytes("\n"+"1");
					System.out.println("Check Agent 13 running.........");
				}
				else
				{
					s=Integer.toString(agent_count);
