...
public class PixelAgent16 extends Agent
{
		protected void setup()
		{
			long startTime = System.currentTimeMillis();
			//System.out.println("Pixel Agent 16 time:"+startTime);
		...
		int n_agents=0,iv1=0,iv2=0,running=0;
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file16.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 16 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 16 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 16 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
