...
public class PixelAgent11 extends Agent
{
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file11.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 11 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 11 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 11 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
