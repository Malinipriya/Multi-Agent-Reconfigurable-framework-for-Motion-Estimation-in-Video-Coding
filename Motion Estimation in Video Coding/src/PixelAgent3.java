...
public class PixelAgent3 extends Agent
{
	long startTime;
...
/*		try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file3.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 3 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			catch(Exception e)
			{
				...
				try{
				System.out.println("Pixel Agent 3 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 3 time:"+time);
