...
public class PixelAgent1 extends Agent
{
		long startTime;
		...
		int running=0,n_agents=0;
		int width,height,iv1=0,iv2=0,sadcounter=0,blockcount=1,blockno=0,loop1=1;
		...
		public void choose_currentblock_frame1() 
		{
			int j=0,count=0;
			for(i=0;i<2;i++)
			{
		...
		for (x=frame2.currentblocky[0][0], z=frame1.currentblocky[0][0]; x<frame2.currentblocky[0][0]+16 && z<frame1.currentheight; x++ ,z++) 
		{
			for (y=frame2.currentblockx[0][0], a=frame1.currentblockx[0][0]; y<frame2.currentblockx[0][0]+25 && a<frame1.currentwidth; y++ ,a++) 
			{
				ad=0;
		...
		{	
			int i=0,j=0,count=0,dummy_loop1=1,loop_limit=0;
		...
		//		System.out.println("*******************  BLOCK "+loop1+" COMPARISON  **********************");
				...
				{
					frame1.blockcount=1;
					frame1.choose_currentblock_frame1();
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file1.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 1 running.........");
			...
			try{
				System.out.println("Pixel Agent 1 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 1 time:"+time);
			return true;
		} 
