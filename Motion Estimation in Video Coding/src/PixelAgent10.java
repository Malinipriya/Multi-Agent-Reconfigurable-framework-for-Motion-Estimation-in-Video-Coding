...
public class PixelAgent10 extends Agent
{
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file10.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 10 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 10 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 10 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
