...
public class PixelAgent12 extends Agent
{
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file12.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 12 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 12 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 12 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
