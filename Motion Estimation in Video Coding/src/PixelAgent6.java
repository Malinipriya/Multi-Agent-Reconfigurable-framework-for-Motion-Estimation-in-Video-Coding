...
public class PixelAgent6 extends Agent
{
		long startTime;
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file6.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 6 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 6 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 6 time:"+time);
