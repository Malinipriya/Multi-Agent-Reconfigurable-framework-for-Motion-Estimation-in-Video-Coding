...
public class PixelAgent15 extends Agent
{
		protected void setup()
		{
			long startTime = System.currentTimeMillis();
			//System.out.println("Pixel Agent 15 time:"+startTime);
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file15.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 15 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 15 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 15 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
