...
public class PixelAgent14 extends Agent
{
		protected void setup()
		{
			long startTime = System.currentTimeMillis();
			//System.out.println("Pixel Agent 14 time:"+startTime);
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file14.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 14 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 14 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 14 time:"+endTime);
			return true;
		} 
	}//inner
}//end of class
