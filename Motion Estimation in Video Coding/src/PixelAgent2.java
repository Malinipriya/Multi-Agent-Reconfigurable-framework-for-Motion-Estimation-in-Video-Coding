...
public class PixelAgent2 extends Agent
{
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file2.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 2 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 2 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 2 time:"+time);
