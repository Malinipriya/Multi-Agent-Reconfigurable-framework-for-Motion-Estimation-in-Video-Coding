...
public class PixelAgent8 extends Agent
{
		long startTime;
...
/*			try
			...
			try
			{
				RandomAccessFile raf = new RandomAccessFile("D:/Java/classes/human_action/file8.txt", "rw");
				...
				if(running==1)
				{
					System.out.println("Pixel Agent 8 running.........");
					PixelAgentBehaviour frame1;
					PixelAgentBehaviour frame2;
			...
			try{
				System.out.println("Pixel Agent 8 killed");
		...
		public boolean done() 
		{
			...
			//System.out.println("Pixel Agent 8 time:"+time);
			return true;
		} 
	}//inner
}//end of class
